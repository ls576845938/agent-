# Research Report v2: exp_fa9e4f8735d7408d

**Strategy:** trend_momentum  
**Status:** PROMOTED_TO_CANDIDATE  
**Created:** 2026-05-11T02:49:31.954886+00:00  
**Symbols:** SPY  
...
| Field | Value |
|-------|-------|
| Experiment ID | exp_fa9e4f8735d7408d |
...
| backtest_manifest_path | data/manifests/run_ubt_20797f0e6f234cd1.json |
| baseline_fill_count | 41 |
| baseline_order_count | 41 |
| cagr_pct | 0.7623 |
| calmar_ratio | 0.9941 |
...
| sortino_ratio | 0.8530 |
| stress_survival_rate | 0.0000 |
| total_fill_count | 41 |
| total_order_count | 41 |
...
1. **Review blocked candidates** (cand_23b43842aa8): Address blocking issues before re-evaluation.
