...
export default function CryptoWorkspace({health, strategies}: CryptoWorkspaceProps) {
  ...
  const buildCryptoClosureRequest = () => {
    ...
    return {
      ...
      strategy_ids: ['btc_low_turnover_trend', 'trend_macd', 'donchian_breakout', 'reversion_rsi', 'volatility_squeeze', 'funding_sentiment', 'macro_trend', 'dynamic_grid', 'time_window'],
